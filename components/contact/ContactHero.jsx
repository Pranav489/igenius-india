...
import { FaStar, FaRocket, FaEnvelope, FaPhone } from 'react-icons/fa';
    ...
    <section className="relative pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-16 sm:pb-20 md:pb-24 overflow-hidden bg-gradient-to-br from-[#395245] to-[#395245]/95">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-5 sm:opacity-10">
        ...
        <div className="absolute top-40 right-40 hidden lg:block">
          <FaEnvelope className="text-yellow text-6xl" />
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          ...
          {/* Description - Using inline style for opacity */}
          <p className="font-body text-white/80 text-sm sm:text-base md:text-lg leading-relaxed mb-6">
            Have questions about our courses, franchise opportunities, or want to schedule a demo? 
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            ...
            >
              <FaPhone className="text-yellow text-sm" />
              <span className="text-white text-sm">+91 7770045402</span>
            </a>
            <a
              href="mailto:info.igeniusnsk@gmail.com"
              className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 rounded-full hover:bg-white/20 transition-colors"
            >
              <FaEnvelope className="text-yellow text-sm" />
              <span className="text-white text-sm">info.igeniusnsk@gmail.com</span>
            </a>
          </div>
        </div>
      </div>
