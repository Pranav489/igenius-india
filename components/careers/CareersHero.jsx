...
import { FaStar, FaRocket, FaBriefcase, FaHeart } from 'react-icons/fa';
    ...
    <section className="relative pt-24 sm:pt-28 md:pt-32 lg:pt-36 pb-16 sm:pb-20 md:pb-24 overflow-hidden bg-gradient-to-br from-[#395245] to-[#395245]/95">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-5 sm:opacity-10">
        ...
        <div className="absolute top-40 right-40 hidden lg:block">
          <FaBriefcase className="text-yellow text-6xl" />
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
          ...
          >
            ...
            <h1 className="font-headline text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
              Build Your Career
              <br />
              <span className="text-yellow">with I-Genius</span>
            </h1>

            {/* Description */}
            <p className="font-body text-white/80 text-sm sm:text-base md:text-lg leading-relaxed mb-6">
              Join India's most trusted abacus academy and be part of a mission to transform 
              children's lives through brain development programs. We're looking for passionate 
              educators and professionals to join our growing family.
            </p>

            {/* Stats Row */}
            <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 mb-6">
              <div className="flex items-center gap-2 bg-white/10 rounded-full px-3 py-1.5">
                <FaBriefcase className="text-yellow w-3 h-3 sm:w-4 sm:h-4" />
                <span className="text-white text-xs sm:text-sm">Multiple Positions</span>
              </div>
              <div className="flex items-center gap-2 bg-white/10 rounded-full px-3 py-1.5">
                <FaHeart className="text-yellow w-3 h-3 sm:w-4 sm:h-4" />
                <span className="text-white text-xs sm:text-sm">Great Work Culture</span>
              </div>
            </div>
          </motion.div>
          ...
          >
              ...
              <div className="relative w-full h-[250px] sm:h-[300px] md:h-[350px] rounded-xl overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <div className="bg-yellow/90 backdrop-blur-sm rounded-full px-3 py-1.5">
                    <span className="font-headline text-dark-green text-xs font-bold">We're Hiring!</span>
                  </div>
                </div>
                
                <div className="absolute bottom-4 right-4">
                  <div className="bg-primary-red/90 backdrop-blur-sm rounded-full px-3 py-1.5">
                    <span className="font-headline text-white text-xs font-bold">Join Our Team</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-4 -left-4 md:-left-8 bg-white rounded-xl p-3 shadow-xl border-2 border-yellow max-w-[200px]">
              <p className="font-accent text-dark-green text-xs">"Be part of something meaningful"</p>
            </div>
          </motion.div>
        </div>
      </div>
