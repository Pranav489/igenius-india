...
import { FaStar, FaBuilding, FaUsers, FaChalkboardTeacher, FaGlobe } from 'react-icons/fa';
...
const FranchiseStats = ({ stats }) => {
  ...
  const statItems = [
    { icon: FaBuilding, value: stats?.franchises || 550, suffix: '+', label: 'Franchises', color: 'text-primary-red', bg: 'bg-primary-red/10' },
    { icon: FaUsers, value: stats?.students || 150000, suffix: '+', label: 'Students Trained', color: 'text-sky-blue', bg: 'bg-sky-blue/10' },
    { icon: FaChalkboardTeacher, value: stats?.trainers || 50, suffix: '+', label: 'Qualified Trainers', color: 'text-green', bg: 'bg-green/10' },
    { icon: FaGlobe, value: stats?.countries || 5, suffix: '', label: 'Countries', color: 'text-orange', bg: 'bg-orange/10' }
  ];
        ...
        <div className="text-center mb-8 md:mb-12">
          <div className="inline-block relative">
            ...
            <h2 className="font-headline text-3xl md:text-4xl text-dark-green">
              Our <span className="text-primary-red">Network</span>
            </h2>
          </div>
